...
function MyInscription() {
    ...
    const chargerExamens = () => {
        api.get('/inscriptions/all/etudiant')
            .then((rep) => {
        ...
        <div className="container">
            ...
            <div className="page-inner">
                <div className="page-header">
                    <h3 className="fw-bold mb-3">Lise de mes inscriptions</h3>
                </div>
                                        ...
                                        <div className="card-body">

                                            {
                                                mesExamens && mesExamens.length > 0 ? (
                                                        ...
                                                        <tbody>
                                                            {
                                                                ...
                                                                mesExamens.map((ex) => (
                                                                    <tr key={ex.mon_inscription._id} data-key={ex.mon_inscription._id} className='text-center fw-bold'>
                                                                        ...
                                                                        <td>
                                                                            <span className={ex.mon_inscription.statutIns === "Valide" ? "badge badge-success fw-bold" : ex.mon_inscription.statutIns === "En attente" ? "badge badge-warning fw-bold" : "badge badge-danger fw-bold"}>{ex.mon_inscription.statutIns}</span>
                                                                        </td>
                                                                        <td>
                                                    ...
                                                    <div className="text-center">Aucun inscription disponible</div>
                                                )
                                            }
